...
public class SoccerModeTest {
	...
	public void testToString() {
		assertEquals("Incorrect String Representation", "Soccer Mode", s.toString());
	}
	
	@Test 
	public void testAddModeRobots() {
		String robots = "robots";
		assertEquals("Did not add Ball robot", "robots, robots.theBall*", s.addModeRobots(robots));
	}
	
	@Test
	public void testGetDescription() {
		assertEquals("Incorrect Description", "Robocode soccer.", s.getDescription());
	}
	...
	public void testComputeInitialPositions() {
		...
		assertArrayEquals("Incorrect Initial Positions", expectedInitialPositions, s.computeInitialPositions("", width, height, robotsCount));		
	}
	
	@Test
	public void testGuiOptions() {
		s.setGuiOptions();
		assertEquals("Show Results is false", true, s.getGuiOptions().getShowResults());
		assertEquals("Show Robot Buttons is true", false, s.getGuiOptions().getShowRobotButtons());
	}
