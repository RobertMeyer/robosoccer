...
public class BallBot extends Ball {
	...
	public void onHitByBullet(HitByBulletEvent e) {
		...
		/*Velocity of the ball in the normal direction after collision
		 * v2 = (u2 * (m2 - m1) + 2m1*u1) / (m1+m2)
		 * 
		 * As this is suppose to mimic a foot with great force kicking
		 * a small air-filled soccer ball, the mass of the ball is 1 
		 * and the mass of the bullet is some arbitrarily large number
		 * (1000)
		 */
		...
		/* Vector velocity of the ball in the tangential direction after collision*/
		...
		setTurnRightRadians(Utils.normalRelativeAngle(finalHeading
				- getHeadingRadians()));
	...
	/**
	 * On hitting a wall the ball will bounce off at a reflective angle. This
	 * is to mimic a real ball hitting a wall.
	 * 
	 */
