...
public final class RbSerializer {
    ...
    public final static byte LandmineStatus_TYPE = 56;
    public final static byte LandmineCommand_TYPE = 57;
    public final static byte Landmine_TYPE = 58;
    public final static byte HitByLandmineEvent_TYPE = 59;
    public final static byte LandmineHitEvent_TYPE = 60;
