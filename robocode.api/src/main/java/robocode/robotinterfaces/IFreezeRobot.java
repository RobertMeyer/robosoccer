...
/**
 * A Robot interface for creating a robot that has the ability to freeze other 
 * robots. Currently a clone of IAdvancedRobot.
 * 
 ...
 * @since 1.6
 */
public interface IFreezeRobot extends IBasicRobot {
