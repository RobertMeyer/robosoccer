 ...
 * @author Clare Heesh (contributor)
 * @author Nathan Dench (contributor)
 * @author Roan Coetzee (contributor)
 * @author Emily Tucker (contributor)
 ...
 * @see Droid
 */
public class HeatRobot extends _AdvancedRadiansRobot implements IHeatRobot, IAdvancedRobot, IAdvancedEvents {
	 ...
	 * @see FreezeRobot#setTurnLeft(double) setTurnLeft(double)
	 * @see #turnLeft(double)
	 * @see #turnLeftRadians(double)
	 * @see #turnRight(double)
	 * @see #turnRightRadians(double)
	 * @see FreezeRobot#setTurnRight(double) setTurnRight(double)
	 * @see FreezeRobot#setTurnRightRadians(double) setTurnRightRadians(double)
	 */
	 ...
	 * @see #turnLeftRadians(double)
	 * @see FreezeRobot#setTurnLeft(double) setTurnLeft(double)
	 * @see FreezeRobot#setTurnLeftRadians(double) setTurnLeftRadians(double)
	 */
	 ...
	 * @see FreezeRobot#setTurnGunLeft(double) setTurnGunLeft(double)
	 * @see #turnGunLeft(double)
	 * @see #turnGunLeftRadians(double)
	 * @see #turnGunRight(double)
	 * @see #turnGunRightRadians(double)
	 * @see FreezeRobot#setTurnGunRight(double) setTurnGunRight(double)
	 * @see FreezeRobot#setTurnGunRightRadians(double) setTurnGunRightRadians(double)
	 * @see #setAdjustGunForRobotTurn(boolean)
	 */
	 ...
	 * @see #turnGunLeftRadians(double)
	 * @see FreezeRobot#setTurnGunLeft(double) setTurnGunLeft(double)
	 * @see FreezeRobot#setTurnGunLeftRadians(double) setTurnGunLeftRadians(double)
	 * @see #setAdjustGunForRobotTurn(boolean)
	 */
	 ...
	 * @see FreezeRobot#setTurnRadarLeft(double) setTurnRadarLeft(double)
	 * @see #turnRadarLeft(double)
	 * @see #turnRadarLeftRadians(double)
	 * @see #turnRadarRight(double)
	 * @see #turnRadarRightRadians(double)
	 * @see FreezeRobot#setTurnRadarRight(double) setTurnRadarRight(double)
	 * @see FreezeRobot#setTurnRadarRightRadians(double) setTurnRadarRightRadians(double)
	 ...
	 * @see #turnRadarLeftRadians(double)
	 * @see FreezeRobot#setTurnRadarLeft(double) setTurnRadarLeft(double)
	 * @see FreezeRobot#setTurnRadarLeftRadians(double) setTurnRadarLeftRadians(double)
	 * @see #setAdjustRadarForRobotTurn(boolean)
	 * @see #setAdjustRadarForGunTurn(boolean)
	 */
	 ...
	 * @see FreezeRobot#getGunTurnRemaining()
	 * @see FreezeRobot#getTurnRemaining() getTurnRemaining()
	 * @see #getTurnRemainingRadians()
	 * @see FreezeRobot#getRadarTurnRemaining() getRadarTurnRemaining()
	 ...
	 * @see FreezeRobot#getRadarTurnRemaining()
	 * @see FreezeRobot#getTurnRemaining() getTurnRemaining()
	 * @see #getTurnRemainingRadians()
	 * @see FreezeRobot#getGunTurnRemaining() getGunTurnRemaining()
	 ...
	 * @see FreezeRobot#getTurnRemaining()
	 * @see FreezeRobot#getGunTurnRemaining() getGunTurnRemaining()
	 * @see #getGunTurnRemainingRadians()
	 * @see FreezeRobot#getRadarTurnRemaining() getRadarTurnRemaining()
	 * @see #getRadarTurnRemainingRadians()
