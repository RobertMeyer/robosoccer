...
public class DefensiveSoccerPlayer extends SoccerRobot {
	...
	public boolean move(ScannedRobotEvent ball) {
		 ...
		 * outward at an angle away from our own goals top and bottom. 
		 * We use this triangle as the bounds of the ideal positioning of our
		 * robot. In DefensiveRobot, by positioning our robot within the 
		 * triangle, we have placed ourselves at some point directly between
		 * the ball and our own goals, increases our chances of obstructing the
		 * ball.
		 */
		...
		/* 
		 * This frankly terrible bit of code determines whether the polygon 
		 * (our desired location on the field), is above or below us, so that
		 * we can move in the right direction to get to the polygon. There
		 * are many more efficient ways to do this.
		 */
	...
	public void onWin (WinEvent event) {
	 ...
	 public void onPaint(Graphics2D g) {
	  ...
	  // Draw enemy goal coloured Green
	     ...
	     int[] triPointsX = {(int) lastBallX, (int) (ownGoal.getCenterX()), (int) (ownGoal.getCenterX())};
	     int[] triPointsY = {(int) lastBallY, (int) (ownGoal.getMaxY()), (int) (ownGoal.getMinY())};
